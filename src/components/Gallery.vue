...
const y1 = computed(() => isDesktop.value ? `translateY(${y.value * 0.15}px) scale(${1 + y.value * 0.0002}) skewY(${y.value * 0.01}deg)` : 'none')
const y2 = computed(() => isDesktop.value ? `translateY(${y.value * 0.25}px) scale(${1 + y.value * 0.0003}) skewY(${y.value * -0.015}deg)` : 'none')
const y3 = computed(() => isDesktop.value ? `translateY(${y.value * 0.2}px) scale(${1 + y.value * 0.00025}) skewY(${y.value * 0.012}deg)` : 'none')
const y4 = computed(() => isDesktop.value ? `translateY(${y.value * 0.3}px) scale(${1 + y.value * 0.00035}) skewY(${y.value * -0.01}deg)` : 'none')
</script>
    ...
    <div class="container mx-auto px-2 relative">
      <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-6 w-full">
        ...
        <div :style="{ transform: y1 }" class="flex flex-col gap-2 md:gap-8 transition-transform duration-75 ease-out will-change-transform mt-4 md:mt-0">
          <div class="relative h-[180px] md:h-[38vh] w-[115%] -ml-[5%] md:w-full md:ml-0 rounded-[1rem] md:rounded-[1.5rem] overflow-hidden shadow-xl rotate-3 md:rotate-0 z-10 mb-0">
            <img :src="images[0]" class="w-full h-full object-cover" alt="Gallery 1" />
          </div>
          <div class="relative h-[160px] md:h-[30vh] w-[90%] ml-[10%] md:w-[110%] md:-ml-[5%] rounded-[1rem] overflow-hidden shadow-lg border-4 md:border-6 border-white z-20 rotate-0 md:rotate-0">
        ...
        <div :style="{ transform: y2 }" class="flex flex-col gap-2 md:gap-8 md:pt-8 transition-transform duration-75 ease-out will-change-transform mt-0 md:mt-0 pl-2">
           <div class="relative h-[200px] md:h-[36vh] w-[110%] -ml-[5%] md:w-full md:ml-0 rounded-[1rem] md:rounded-[1.5rem] overflow-hidden shadow-lg -rotate-1 md:rotate-2 z-0 mb-0">
            <img :src="images[1]" class="w-full h-full object-cover scale-105" alt="Gallery 3" />
          </div>
          <div class="relative h-[180px] md:h-[40vh] w-full md:w-[105%] md:-ml-[3%] rounded-[1rem] md:rounded-[1.5rem] overflow-hidden shadow-xl z-10 border-4 border-white rotate-2 md:rotate-0">
        ...
        <div :style="{ transform: y3 }" class="flex flex-col gap-2 md:gap-6 md:pt-6 transition-transform duration-75 ease-out will-change-transform mt-0 md:mt-0">
           <div class="relative h-[190px] md:h-[38vh] w-[110%] -ml-[5%] md:w-[105%] md:-ml-[3%] rounded-[1rem] md:rounded-[1.5rem] overflow-hidden shadow-lg rotate-1 md:-rotate-1 z-10 mb-0">
            <img :src="images[2]" class="w-full h-full object-cover" alt="Gallery 5" />
          </div>
           <div class="relative h-[160px] md:h-[28vh] w-[80%] ml-[15%] md:w-[80%] md:ml-[5%] rounded-full overflow-hidden shadow-md border-4 md:border-8 border-white z-30">
        ...
        <div :style="{ transform: y4 }" class="flex flex-col gap-2 md:gap-8 md:pt-8 transition-transform duration-75 ease-out will-change-transform mt-2 md:mt-0 pl-2">
          <div class="relative h-[180px] md:h-[32vh] w-[105%] -ml-[2.5%] md:w-full md:ml-0 rounded-[1rem] md:rounded-[1.5rem] overflow-hidden shadow-lg -rotate-3 md:rotate-0 z-0 mb-0">
             <img :src="images[3]" class="w-full h-full object-cover" alt="Gallery 7" />
          </div>
           <div class="relative h-[220px] md:h-[36vh] w-[110%] -ml-[5%] md:w-[120%] md:-ml-[20%] rounded-[1rem] md:rounded-[2rem] overflow-hidden shadow-xl border-4 border-white z-20 rotate-1 md:rotate-0">
