  ...
  <section ref="container" class="relative py-12 md:py-20 bg-white overflow-hidden">
    ...
    <div class="container mx-auto px-2 relative">
      <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-0 md:gap-8 w-full">
        ...
        <div :style="{ transform: y1 }" class="flex flex-col gap-0 md:gap-4 transition-transform duration-75 ease-out will-change-transform mt-8 md:mt-0">
          <div class="relative h-[220px] md:h-[50vh] w-[115%] -ml-[5%] md:w-full md:ml-0 rounded-[1rem] md:rounded-[2rem] overflow-hidden shadow-xl rotate-6 md:rotate-0 z-10 mb-[-40px] md:mb-0">
            <img :src="images[0]" class="w-full h-full object-cover" alt="Gallery 1" />
          </div>
          <div class="relative h-[180px] md:h-[35vh] w-[90%] ml-[15%] md:w-[120%] md:-ml-[10%] rounded-[1rem] md:rounded-full overflow-hidden shadow-lg border-4 md:border-8 border-white z-20 -rotate-3 md:rotate-0">
             <img :src="images[4]" class="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" alt="Gallery 2" />
          </div>
        </div>

        <div :style="{ transform: y2 }" class="flex flex-col gap-0 md:gap-4 md:pt-0 transition-transform duration-75 ease-out will-change-transform mt-0 md:mt-0 pl-2">
          ...
          <div class="relative h-[200px] md:h-[40vh] w-full md:w-[110%] md:-ml-[5%] rounded-[1rem] md:rounded-[2rem] overflow-hidden shadow-xl z-10 border-4 border-white rotate-3 md:rotate-0">
            <img :src="images[5]" class="w-full h-full object-cover" alt="Gallery 4" />
          </div>
        </div>

        <div :style="{ transform: y3 }" class="flex flex-col gap-0 md:gap-4 md:pt-0 transition-transform duration-75 ease-out will-change-transform mt-[-20px] md:mt-0">
           <div class="relative h-[240px] md:h-[50vh] w-[120%] -ml-[10%] md:w-[110%] md:-ml-[5%] rounded-[1rem] md:rounded-[2rem] overflow-hidden shadow-xl rotate-2 md:-rotate-2 z-10 mb-[-50px] md:mb-0">
            <img :src="images[2]" class="w-full h-full object-cover" alt="Gallery 5" />
          </div>
           <div class="relative h-[180px] md:h-[25vh] w-[80%] ml-[20%] md:w-[80%] md:ml-[10%] rounded-full overflow-hidden shadow-lg border-4 md:border-[12px] border-white z-30">
            <img :src="images[6]" class="w-full h-full object-cover" alt="Gallery 6" />
          </div>
        </div>

        <div :style="{ transform: y4 }" class="flex flex-col gap-0 md:gap-4 md:pt-0 transition-transform duration-75 ease-out will-change-transform mt-4 md:mt-0 pl-2">
          <div class="relative h-[190px] md:h-[45vh] w-[105%] -ml-[2.5%] md:w-full md:ml-0 rounded-[1rem] md:rounded-[2rem] overflow-hidden shadow-xl -rotate-6 md:rotate-0 z-0 mb-[-20px] md:mb-0">
             <img :src="images[3]" class="w-full h-full object-cover" alt="Gallery 7" />
          </div>
           <div class="relative h-[280px] md:h-[30vh] w-[110%] -ml-[5%] md:w-[140%] md:-ml-[40%] rounded-[1rem] md:rounded-[4rem] overflow-hidden shadow-2xl border-4 border-white z-20 rotate-2 md:rotate-0">
